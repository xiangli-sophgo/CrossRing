...
class SimulationConfig:
    def __init__(self, default_config):
        ...
        self.ue_max_T0 = args.ue_max_T0
        self.ue_max_T1 = args.ue_max_T1
        self.ue_max_T2 = args.ue_max_T2
        self.update_config()
    ...
    def parse_args(self, default_config):
        ...
        parser.add_argument("--ue_max_T0", type=int, default=default_config["ue_max_T0"], help="ETag T0 FIFO size")
        parser.add_argument("--ue_max_T1", type=int, default=default_config["ue_max_T1"], help="ETag T1 FIFO size")
        parser.add_argument("--ue_max_T2", type=int, default=default_config["ue_max_T2"], help="ETag T2 FIFO size")
