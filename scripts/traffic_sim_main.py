...
def main():
    ...
    parser.add_argument("--results_file_name", default="DeepSeek0616_1030_10us_dc_ip_all", help="Base name for results files")
    ...
    parser.add_argument("--max_workers", type=int, default=8, help="Maximum number of parallel workers (default: number of CPU cores)")
