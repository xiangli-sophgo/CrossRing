...
def main():
    ...
    parser.add_argument("--traffic_output", default=r"../traffic/DeepSeek_0922", help="Output directory for processed data")
    ...
    parser.add_argument("--results_file_name", default="DeepSeek0922_925_10us", help="Base name for results files")
    ...
    parser.add_argument("--max_workers", type=int, default=7, help="Maximum number of parallel workers (default: number of CPU cores)")
