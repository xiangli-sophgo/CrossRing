...
def find_optimal_parameters():
    ...
    results_file_name = "RN_Tracker_OSTD_Results"
    ...
    # 定义参数范围
    parm1_start, parm1_end, parm1_step = (16, 96, 4)
    parm2_start, parm2_end, parm2_step = (16, 96, 4)
    ...
    for parm1 in range(parm1_start, parm1_end + 1, parm1_step):  # 使用 parm1_end + 1 以包含结束值
        for parm2 in range(parm2_start, parm2_end + 1, parm2_step):  # 使用 parm2_end + 1 以包含结束值
            ...
            results = {
                ...
                "gdam-R-L2M_thoughput": sim.gdma_R_l2m_flit_num * 128 / sim.gdma_R_l2m_finish_time / 4 if sim.gdma_R_l2m_finish_time > 0 else 0,
                "sdma-R-DDR_finish_cycle": sim.sdma_R_ddr_finish_time,
                "sdma-W-l2m_finish_cycle": sim.sdma_W_l2m_finish_time,
                "gdam-R-L2M_finish_cycle": sim.gdma_R_l2m_finish_time,
                ...
                "gdam-R-L2M_avg_latency": np.average(sim.gdma_R_l2m_latency) if sim.gdma_R_l2m_latency else 0,
                "cir_h_total": sim.cir_h_total,
                "cir_v_total": sim.cir_v_total,
                "Topo": topo_type,
            }
