...
class V2Config(KCINConfigBase):
    ...
    def _apply_config(self, config: Dict[str, Any]):
        ...
        # ==================== RingStation 配置 ====================
        self.RS_IN_CH_BUFFER = config.get("RS_IN_CH_BUFFER", 4)
        self.RS_IN_FIFO_DEPTH = config.get("RS_IN_FIFO_DEPTH", 4)
        self.RS_OUT_CH_BUFFER = config.get("RS_OUT_CH_BUFFER", 4)
        self.RS_OUT_FIFO_DEPTH = config.get("RS_OUT_FIFO_DEPTH", 4)
