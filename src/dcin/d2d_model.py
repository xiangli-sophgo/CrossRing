...
from src.kcin.v1.base_model import BaseModel
from .d2d_traffic_scheduler import D2DTrafficScheduler
from src.analysis.d2d_analyzer import D2DAnalyzer
from src.dcin.components import D2D_RN_Interface, D2D_SN_Interface
...
class D2D_Model:
    ...
    def __init__(self, config: V1Config, traffic_config: list = None, **kwargs):
        self.config = config
    ...
    def _create_die_config(self, die_id: int) -> V1Config:
        ...
        if topology_str:
            ...
            try:
                die_config = V1Config(kcin_config_path)
            except Exception as e:
    ...
    def _add_d2d_nodes_to_die(self, die_model: BaseModel, die_id: int):
        ...
        from src.dcin.components import D2D_Sys
    ...
    def _create_ip_interface_for_die(self, die_model, ip_type: str, node_id: int):
        ...
        Args:
            ...
            node_id: 节点ID
        """
        from src.kcin.v1.components.ip_interface import IPInterface
